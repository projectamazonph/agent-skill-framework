...
| Finding | Route |
| --- | --- |
| Missing behavior proof or weak assertion | test-driven-development |
| Responsibility, extension, substitution, interface, dependency issue | solid-design |
| Repeated failure, regression, or unclear cause | loop-engineering |
| Scope or authorization problem | engineering-orchestrator Intake |
